...
export const products: Product[] = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                key: "mini-trainer-bundle",
                title: "Bundle (PDF + Audio)",
                price: 22,
